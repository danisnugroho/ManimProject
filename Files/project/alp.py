...
for i in range(1001):
    ...
    # Take the first 10 rows for three nucleons (red, blue, green, and yellow)
...
class AlphaAnimation(ThreeDScene):
    def construct(self):
        ...
        yellow_particles = [Sphere(radius=0.05, color=YELLOW).move_to(yellow_coordinates[0][i]).set_color(YELLOW) for i in range(10)]
