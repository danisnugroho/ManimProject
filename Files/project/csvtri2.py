...
folder_path = r"C:\Users\danis\Desktop\MFG 598 Project\ManimProject\data\triton2"
...
class TritonAnimation(ThreeDScene):
    def construct(self):
        ...
        green_particles = [Sphere(radius=0.1, color=GREEN).move_to(g[0][i]).set_color(GREEN) for i in range(N)]
